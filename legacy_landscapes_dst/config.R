...
objectives_strategy <-
  p(h4("The conservation objectives"),
    ...
    p("The six different conservation objectives can be combined into different
       ...
       importance (weight) can be seen in the", strong(em("Ranking Table")), "tab. The location
       of the top scoring sites can be seen in the", strong(em("Ranking Map")), "tab."),
...
Rtable_text <-
  ...
  em(strong("Select focal realm")), em("buttons above the table, the ranking table can be subset to show the resulting
...
Rmap_text <-
  ...
  p(em("The choice of biogeographic realm can be changed by using the"), strong(em("Select focal realm")),
